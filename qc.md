...
* **Dy.** - <ins>d<b>y</b></ins>namic **D**eclaring thinking (that includes Alpha-gamma **Djey.**: FeS, TeN and **Dpiy.**: SiF, NiT).  
...
* **Qo.** - n<ins>**o**</ins>ndynamic **Q**uestioning thinking (that includes Alpha-gamma **Qjio.**: TiN, FiS and **Qpeo.**: NeT, SeF).  
...
* **Qy.** - <ins>d<b>y</b></ins>namic **Q**uestioning thinking (that includes Beta-delta **Qjey.**: FeN, TeS and **Qpiy.**: NiF, SiT).  
...
* **Do.** - n<ins>**o**</ins>ndynamic **D**eclaring thinking (that includes Beta-delta **Djio.**: TiS, FiN and **Dpeo.**: SeT, NeF).  
